...
public class Tester {
	...
	public static void main(String[] args) {
		...
		String leyenda;
                //insertar
                leyenda= administradorBD.registrarAlta("categoria", " 1, 'CHETOS','Grande'");
      ...
      //     System.out.println(leyenda);
         ...
         //  leyenda = administradorBD.borrarRegistro("TbEquipo", "id = 6");
           //   System.out.println(leyenda);
                ...
                //consulta
		datosObtenidos = administradorBD.consultarDatos("categoria", "id_categoria , nombre,descripcion","id=1");
                  System.out.println(leyenda);
